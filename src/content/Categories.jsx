...
const Categories = () => {
    return (
        <div className='md:p-5 md:ml-5 mr-5'>
            <div className='flex justify-between w-full'>
                <div className='bg-white rounded-xl p-5 w-full md:w-[20%] m-1'>
                    <Link to='/recepie/sayur'>
                        <div className='flex'>
